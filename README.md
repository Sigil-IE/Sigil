...
* [3.5e Weapon Style Rebalance](http://www.shsforums.net/files/download/1205-35-edition-weapon-style-rebalance/) by **Reddbane** *Multiple ways to change the behavior of "Weapon Style" proficiencies.* [Site](http://www.shsforums.net/files/file/1205-35-edition-weapon-style-rebalance/) `EET`
* [AC's Miscellaneous Tweaks](https://www.dropbox.com/s/8ss38cw7bz31968/AC_Miscellaneous.rar?dl=1) by **Andrea Colombo** *Various small tweaks, including changing appearance of items, portraits, and bringing in sound sets across the games.* [Forum](http://www.shsforums.net/topic/61094-acs-miscellaneous-tweaks/) `EET`
* [Achievements!](https://lynxlynx.info/ie/modhub.php?Argent77/A7-Achievements&pkg=wzp&pre) by **Argent77** *Adds steam achievements as journal entries to any version of the games* [Forum](https://www.gibberlings3.net/forums/topic/33035-achievements-for-everyone/) [Site](https://github.com/Argent77/A7-Achievements) `EET`
* [Animal Companions NPC](http://www.shsforums.net/files/download/1064-animal-companions/) [(GH)](https://github.com/thisisulb/AnimalCompanions/archive/master.zip) by **Ulb** *Gives rangers and optionally druids the ability to befriend a permanent animal companion.* [Forum](http://www.shsforums.net/topic/56242-animal-companions/) `EET`
* [Artemius' House Tweaks](https://lynxlynx.info/ie/modhub.php?ArtemiusI/House-Rule-Tweaks&master) by **Artemius_I** *Tweaks for dialogue, rules, stats, graphics, animations* [Forum](https://forums.beamdog.com/discussion/56035/v1-6-artemius-is-house-rule-tweaks-most-recent-moved-all-kit-components) [Site](https://artisans-corner.com/house-rules/) `EET`
* [aTweaks](https://github.com/FredrikLindgren/aTweaks/archive/v4.53.zip)[(SHS)](http://www.shsforums.net/files/download/709-atweaks-windows-version/) by **aVENGER & Wisp** *Gameplay tweaks and changes* [Forum](http://www.shsforums.net/forum/598-atweaks/)  [Site](http://www.shsforums.net/files/file/709-atweaks-windows-version/) `EET`
## Graphics
## Portraits
* [Ace's Enchanters Portrait Pack](https://www.gibberlings3.net/files/file/1007-aces-enchanters-portrait-pack/?do=download&r=4539&confirm=1&t=1&csrfKey=a8dc7612ebac81c803f022ba326b8c96) by **theacefes** *A collection of 8 portraits from the character art of the Enchanters book series.* [Forum](https://www.gibberlings3.net/forums/forum/28-miscellaneous-released-mods/) [Site](https://www.gibberlings3.net/mods/other/portraitpacks/) `EET`
* [Amaurea's BG Portraits](https://www.gibberlings3.net/files/file/684-amaureas-bg-portraits/?do=download&r=4473&confirm=1&t=1&csrfKey=a8dc7612ebac81c803f022ba326b8c96) by **Amaurea (portraits), Berelinde (code)** *Alternative portraits for every BG companion (may be used by the player).* [Forum](https://www.gibberlings3.net/forums/forum/28-miscellaneous-released-mods/) [Site](https://www.gibberlings3.net/mods/other/portraitpacks/) `EET`
* [Amaurea's BG2 Portraits](https://www.gibberlings3.net/files/file/683-amaureas-bg2-portraits/?do=download&r=4477&confirm=1&t=1&csrfKey=a8dc7612ebac81c803f022ba326b8c96) by **Amaurea** *Alternative portraits for every BGII companion (may be used by the player).* [Forum](https://www.gibberlings3.net/forums/forum/28-miscellaneous-released-mods/) [Site](https://www.gibberlings3.net/mods/other/portraitpacks/) `EET` 
* [Artaport](https://drive.google.com/file/d/0ByC2MsHREt59SEY4NGRXWnFIR3c/view)(https://github.com/Eltamin/artaport/archive/master.zip) by **Artrastrophe, Etamin** *Adds over 100 portraits for the player, optionally replaces companion portraits and adds portraits to non-joinable NPCs* [Forum](https://forums.beamdog.com/discussion/51904/mod-artaport-3-1#latest) [Site](https://github.com/Eltamin/artaport) `EET`
## Sound
* [AC's Miscellaneous Tweaks](https://www.dropbox.com/s/8ss38cw7bz31968/AC_Miscellaneous.rar?dl=1) by **Andrea Colombo** *Various small tweaks, including changing appearance of items, portraits, and bringing in sound sets across the games.* [Forum](http://www.shsforums.net/topic/61094-acs-miscellaneous-tweaks/) `EET`
